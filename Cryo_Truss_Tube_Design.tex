...
%\section{Property Results of Useful Materials} <- probably not necessary
...
\end{center}
\caption{Material strength properties of some select materials at room temperature.\textcolor{yellow}{we should include density and heat capacity extimates}}
\label{SW}
\end{figure}
